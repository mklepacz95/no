...
public class Main {
    ...
    public static void main(String[] args) {
        File inputFile = new File("programs/Program2.c");
        ...
        System.out.println("Liczba krawedzi: " + g.getNumberOfEdge());
        System.out.println("Liczba wierzchołków: " + g.getNumberOfNodes());
